...
- Keep Appearance settings in the Other sidebar section, and apply `.preferredColorScheme` from the view that directly observes `SettingsStore` so nested preference changes refresh the window.
